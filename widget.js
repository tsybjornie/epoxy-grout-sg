...
(function () {
  ...
  var QA = [
    ...
    [['brand', 'product', 'mapei', 'kerapoxy', 'ardex', 'sika'],
      'Two-part epoxy only: Mapei Kerapoxy CQ, Ardex or Sika, mixed on site against the pot life. Receipt and batch numbers shown before work starts.'],
    [['flexcolor', 'flexcolour', 'cq', 'ready-mixed', 'ready mixed', 'premixed', 'pre-mixed', 'tub', 'haze', 'hazing'],
      'Flexcolor CQ and Kerapoxy CQ are different Mapei products despite the shared name. Flexcolor CQ is ready-mixed single-part grout from a tub — not an epoxy. We apply Kerapoxy CQ, the true two-part epoxy: mixed on site in small batches against the pot life, joints cleaned and de-hazed before it sets. Covered by the 5-year written warranty.',
      ['/faq.html', 'More in the FAQ →']],
